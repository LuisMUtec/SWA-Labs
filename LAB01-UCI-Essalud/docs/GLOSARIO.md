...
| Confirmación de lectura | Registro de que un profesional consultó un cambio de la programación vigente que lo afecta o una programación publicada que le asigna alguna franja de su periodo, con su autoría e instante, distinto del acuse, que registra la recepción de un aviso y no su consulta; mientras ese registro no existe, la lectura de ese profesional está pendiente. |
...
| Registro clínico retenido | Registro clínico producido en un equipo compartido por un profesional que no contaba en él con identidad verificada vigente propia, conservado fuera del episodio y sin autoría atribuida hasta que un profesional lo declara propio en ese equipo. |
