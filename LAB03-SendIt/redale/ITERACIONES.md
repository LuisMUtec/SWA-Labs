...
**Gate ≥ 8 — alcanzado en la iteración 17 con 8,0045 y perdido en la 18 con 7,67.** El agregador declaró el 8,0045 dentro de la resolución del instrumento —un hallazgo más de `D4` habría dado 7,98— y la 18 lo revirtió por un escalón de media unidad en `D3` que **sí** está por encima del ruido: `RF-202` contra `RF-94`. El detalle de cada corrida está en
