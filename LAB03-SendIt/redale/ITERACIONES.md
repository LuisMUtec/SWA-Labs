...
**Gate ≥ 8 — ALCANZADO en la iteración 17 con 8,0045, por 0,0045.** El agregador lo declara dentro de la resolución del instrumento: un hallazgo más de `D4` habría dado 7,98. El detalle de cada corrida está en
