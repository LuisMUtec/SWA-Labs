...
| El reparto de los once servidores de `E` | Nada de este paso, salvo una cosa: hoy **no hay nodo para el `Desafío Service`**, que `D`(f) exige con proceso y base propios y por el que pasa el `20 %` de los pagos que RNF-11 mide. Se devuelve a [`E`](../E-estimar/README.md) como fila nueva de su tabla de planos, no se recalcula acá |
