...
declarar **por llamada o mensaje de texto**»*, y RF-180 lo confirma al exigir identificar como el
...
ventanilla sino una declaración **por llamada o mensaje de texto**, y RF-180 obliga a identificar a
...
| Admitir una declaración de diferencia hecha fuera del mostrador | escritura + identificación remota + atribución al punto | RF-90, RF-180, RF-59 | 8 | **26** = `13` declaraciones (S-17) `+ 13` identificaciones del declarante (RF-180) | Escritura. **No es ventanilla**: RF-90 llega por llamada o SMS |
...
| Identificación de quien declara una diferencia fuera del mostrador (RF-180) | `+13` |
...
| Declaración de diferencia del receptor, su atribución y su liquidación (RF-90, RF-180, RF-59, RF-104, RF-143, RF-145) | Lo que el receptor declara **por llamada o SMS**, la identificación que RF-180 exige antes de admitirla, la atribución al punto, el informe previo con evidencia que RF-104 obliga a darle al agente, el descuento de RF-143 y la objeción de RF-145 | 12 KB | `0,005` (S-17) | **0,17 MB** | 8,7 | `[ASSUMPTION: S-17]` |
