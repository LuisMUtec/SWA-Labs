...
- **Handover Record**: condition, Operating-Hours Reading, Custodian, Contracted Site, the Custodian's departure-reporting obligation and what a recovery would take, at handover, accepted by both sides. Immutable; supersedable.
...
2. Fleet Manager records the handover — condition, hours, named Custodian, Contracted Site, the Custodian's departure-reporting obligation, and what recovering the machine would take — and both sides accept.
