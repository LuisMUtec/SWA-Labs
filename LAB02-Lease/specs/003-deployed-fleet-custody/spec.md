...
- **AC-018b**: **Given** a live Deployment whose operation's Acquisition Option is `available` and neither exercised nor declined, **When** Fleet Manager asks which end it is heading for, **Then** the answer is "not yet determined" — distinguishable from both Return and Acquisition Retirement. *(FR-016)*
