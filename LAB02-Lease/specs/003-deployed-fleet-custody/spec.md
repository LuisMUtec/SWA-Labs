...
- **AC-037f**: **Given** a completed service or a recorded Incident on a deployed machine, **When** it is recorded, **Then** the machine's Assessed Value is revalued. *(FR-031b)*
