...
- **What a handover requires**: a condition record, an Operating-Hours Reading, a named Custodian, a Contracted Site, the Custodian's acceptance of the obligation to report a departure from that site (FR-014b), what recovering the machine from that site would take (FR-030), and the machine's Assessed Value (FR-031b) — all seven, accepted by both sides. The last is there because the day it is needed is the day nobody will help gather it. A handover missing any of them is not a handover this feature performs, because the whole value of the record is that it was agreed before there was anything to argue about.
...
- **FR-003**: The system MUST require a handover to carry the machine's condition, an Operating-Hours Reading, a named Custodian, a Contracted Site, the Custodian's acceptance of the departure-reporting obligation of FR-014b, what a recovery of that machine from that site would take (FR-030), and the machine's Assessed Value (FR-031b), each accepted by both Lea$e and the client, and MUST NOT open a Deployment when any is missing.
...
- **Handover Record**: condition, Operating-Hours Reading, Custodian, Contracted Site, the Custodian's departure-reporting obligation, what a recovery would take and the machine's Assessed Value, at handover, accepted by both sides. Immutable; supersedable.
...
2. Fleet Manager records the handover — condition, hours, named Custodian, Contracted Site, the Custodian's departure-reporting obligation, what recovering the machine would take, and its Assessed Value — and both sides accept.
