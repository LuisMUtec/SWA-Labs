...
- **SC-005**: For a Project whose milestone passes its expected date uncertified, the warning reaches the deciding Underwriter while the operation is still open — not closed by any of `003`'s three ends and carrying no Default Declaration — and before any instalment is overdue.
